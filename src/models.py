class Game(object):
    def __init__(self, name, player_cards, board_cards):
        self.name = name
    ...
    def is_straight(self):
        if len(self.cards) == 5:
            ...
            if test_for_aces is None:
                ...
                if (
                    sc[0].numeric_value == sc[1].numeric_value - 1
                    and sc[1].numeric_value == sc[2].numeric_value - 1
                    and sc[2].numeric_value == sc[3].numeric_value - 1
                    and sc[3].numeric_value == sc[4].numeric_value - 1
                ):
                    return True
                else:
                    return False
                ...
                if (
                    c1[0]["value"] == c1[1]["value"] - 1
                    and c1[1]["value"] == c1[2]["value"] - 1
                    and c1[2]["value"] == c1[3]["value"] - 1
                    and c1[3]["value"] == c1[4]["value"] - 1
                ) or (
                    c2[0]["value"] == c2[1]["value"] - 1
                    and c2[1]["value"] == c2[2]["value"] - 1
                    and c2[2]["value"] == c2[3]["value"] - 1
                    and c2[3]["value"] == c2[4]["value"] - 1
                ):
                    return True
                else:
                    return False
